...
impl Router {
    ...
    fn router() -> matchit::Router<u32> {
        ...
        router.insert("/history", 8u32).unwrap();
        router.insert("/labels", 9u32).unwrap();
        router.insert("/labels/{id}", 10u32).unwrap();
        router.insert("/login", 11u32).unwrap();
        router.insert("/logout", 12u32).unwrap();
        router.insert("/signup", 13u32).unwrap();
        router.insert("/static/output.css", 14u32).unwrap();
        router.insert("/theme", 15u32).unwrap();
        router.insert("/todos", 16u32).unwrap();
        router.insert("/todos/{id}", 17u32).unwrap();
        router.insert("/todos/{id}/edit", 18u32).unwrap();
        router.insert("/todos/{id}/toggle", 19u32).unwrap();
        router
    }
    pub async fn route(
        &self,
...
pub mod route_2 {
    ...
    async fn handler(
        ...
        let v5 = app::session_theme::Theme::extract(v0).await;
        let v6 = app::routes::pages::labels_page(&v4, v2, &v5).await;
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
...
pub mod route_3 {
    ...
    async fn stage_2<'a, 'b, 'c, 'd, 'e>(
        ...
        let response = handler(s_4, s_5, s_2, &s_3, s_6).await;
        let response = post_processing_0(response, s_2).await;
        let response = post_processing_1(response, s_3, &mut s_0, s_1, s_2).await;
        let response = post_processing_2(response, s_0, s_1, s_2).await;
        response
    ...
    async fn handler(
        ...
        let v10 = app::session_auth::SessionUserId::extract(v3).await;
        let v11 = match v10 {
            Ok(ok) => ok,
            Err(v11) => {
                return {
                    let v12 = app::session_auth::SessionUserId::not_logged_in(&v11);
        ...
        let v12 = app::routes::pages::create_label_page(v9, &v11, v4).await;
        let v13 = match v12 {
            Ok(ok) => ok,
            Err(v13) => {
                return {
...
pub mod route_4 {
    ...
    async fn stage_2<'a, 'b, 'c, 'd, 'e, 'f, 'g>(
        ...
        let response = handler(s_4, s_2, s_5, s_6, &s_3, s_7).await;
        let response = post_processing_0(response, s_2).await;
        let response = post_processing_1(response, s_3, &mut s_0, s_1, s_2).await;
        let response = post_processing_2(response, s_0, s_1, s_2).await;
        response
    ...
    async fn handler(
        ...
        let v13 = app::session_auth::SessionUserId::extract(v4).await;
        let v14 = match v13 {
            Ok(ok) => ok,
            Err(v14) => {
                return {
                    let v15 = app::session_auth::SessionUserId::not_logged_in(&v14);
        ...
        let v15 = app::routes::pages::update_label_page(v7, v12, &v14, v5).await;
        let v16 = match v15 {
            Ok(ok) => ok,
            Err(v16) => {
                return {
...
pub mod route_5 {
    ...
    async fn stage_2<'a, 'b, 'c, 'd, 'e, 'f>(
        ...
        let response = handler(s_4, s_2, &s_3, s_5).await;
        let response = post_processing_0(response, s_2).await;
        let response = post_processing_1(response, s_3, &mut s_0, s_1, s_2).await;
        let response = post_processing_2(response, s_0, s_1, s_2).await;
        response
    ...
    async fn handler(
        ...
        let v6 = app::session_auth::SessionUserId::extract(v2).await;
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
                    let v8 = app::session_auth::SessionUserId::not_logged_in(&v7);
                    let v9 = pavex::Error::new(v7);
                    app::telemetry::error_logger(&v9, v1).await;
                    <pavex::Response as pavex::IntoResponse>::into_response(v8)
                };
        ...
        let v8 = app::routes::pages::delete_label_page(v5, &v7, v3).await;
        let v9 = match v8 {
            Ok(ok) => ok,
            Err(v9) => {
                return {
...
pub mod route_12 {
    ...
    async fn handler(
        ...
        let v8 = app::session_theme::Theme::extract(v2).await;
        let v9 = app::routes::pages::history_page(v5, &v7, v3, &v8).await;
        let v10 = match v9 {
            Ok(ok) => ok,
            Err(v10) => {
                return {
...
pub mod route_13 {
    ...
    async fn handler(
        ...
        let v5 = app::session_theme::Theme::extract(v0).await;
        let v6 = app::routes::pages::home_page(&v4, v2, &v5).await;
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
...
pub mod route_14 {
    ...
    async fn handler(
        ...
        let v8 = app::routes::pages::get_todo_page(v5, &v7, v3).await;
        let v9 = match v8 {
            Ok(ok) => ok,
            Err(v9) => {
                return {
...
pub mod route_15 {
    ...
    async fn handler(
        ...
        let v5 = app::session_theme::Theme::extract(v0).await;
        let v6 = app::routes::pages::todos_page(&v4, v2, &v5).await;
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
...
pub mod route_16 {
    ...
    async fn handler(
        ...
        let v12 = app::routes::pages::create_todo_page(v9, &v11, v4).await;
        let v13 = match v12 {
            Ok(ok) => ok,
            Err(v13) => {
                return {
...
pub mod route_17 {
    ...
    async fn handler(
        ...
        let v8 = app::routes::pages::edit_todo_page(v5, &v7, v3).await;
        let v9 = match v8 {
            Ok(ok) => ok,
            Err(v9) => {
                return {
...
pub mod route_18 {
    ...
    async fn handler(
        ...
        let v15 = app::routes::pages::update_todo_page(v7, v12, &v14, v5).await;
        let v16 = match v15 {
            Ok(ok) => ok,
            Err(v16) => {
                return {
...
pub mod route_19 {
    ...
    async fn handler(
        ...
        let v8 = app::routes::pages::toggle_todo_page(v5, &v7, v3).await;
        let v9 = match v8 {
            Ok(ok) => ok,
            Err(v9) => {
                return {
...
pub mod route_20 {
    ...
    async fn handler(
        ...
        let v8 = app::routes::pages::delete_todo_page(v5, &v7, v3).await;
        let v9 = match v8 {
            Ok(ok) => ok,
            Err(v9) => {
                return {
